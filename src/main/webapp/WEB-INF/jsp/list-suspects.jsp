...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/vac-styles.css">
<link rel="stylesheet"
...
<body>
		...
		<table class="table table-striped table-dark">
			...
			<tbody>
				<c:forEach var="tempSuspect" items="${suspects}">
					...
					<tr>
						<td class="cell-nickname"><a
							href="http://steamcommunity.com/profiles/${tempSuspect.steamid}">
								${tempSuspect.username}</a> <span
							class="details details_${tempSuspect.id}">
						...
						<td class="cell-vacstatus"><span class="vacstatus">${tempSuspect.vacStatus}</span>
							<span class="details details_${tempSuspect.id}">
								<hr> <i>Description:</i> ${tempSuspect.description}
						</span></td>
						<td>${fn:substring(tempSuspect.additionDate, 0, 16)}
						<span class="details details_${tempSuspect.id}">
								<hr> <security:authorize url="/suspects/showFormForUpdate">
									<a href="${updateLink}" class="btn btn-info">Update</a>
								</security:authorize> <security:authorize url="/suspects/delete">
						...
						<td>
							<button id="details_${tempSuspect.id}" type="button"
								class="btn btn-light details-button">Details</button>
						</td>
					</tr>
				</c:forEach>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/list-suspects.js"></script>
</body>
</html>